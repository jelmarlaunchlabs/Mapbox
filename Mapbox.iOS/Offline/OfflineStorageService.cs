...
[assembly: Xamarin.Forms.Dependency(typeof(MapBox.iOS.Offline.OfflineStorageService))]
        ...
        public Task<OfflinePack> DownloadMap(OfflinePackRegion formsRegion, Dictionary<string, string> packInfo)
        {
			...
			var region = new MGLTilePyramidOfflineRegion(
				...
				new MGLCoordinateBounds {
					sw = formsRegion.Bounds.SouthWest.toNativeCLLocationCoordinate2D(),
					ne = formsRegion.Bounds.NorthEast.toNativeCLLocationCoordinate2D()
				},
