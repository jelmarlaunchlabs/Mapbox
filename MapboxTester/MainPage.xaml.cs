...
namespace MapboxTester
{
	public partial class MainPage : ContentPage
	{
		public MainPage()
		{
			...
			map.initialCameraUpdate = CameraPerspectiveFactory.fromCenterAndZoomLevel(new Position(10.318342, 123.90506), 10);
			...
			map.pins.Add(new Pin {
				...
				heading = 0,
				position = new Position(10.318392, 123.90596)
			});
			map.pins.Add(new Pin {
				image = "MapPinDestination",
				IsCenterAndFlat = false,
				heading = 0,
				position = new Position(10.31591, 123.97996)
			});
		...
		async void DownloadMap_Clicked(object sender, System.EventArgs e)
		{
			...
			map.dowloadMap("default", 1, 20, new Bounds(new Position(10.237101, 123.837424),
														new Position(10.374214, 123.952245)));
		}
