...
using GoogleGson;
using MapBox.Android.Offline;
using MapBox.Offline;

[assembly: Xamarin.Forms.Dependency(typeof(OfflineStorageService))]
namespace MapBox.Android.Offline
{
	public class OfflineStorageService : IOfflineStorageService
	{
		...
		{
			offlineManager = OfflineManager.GetInstance(Application.Context);
		...
		public Task<OfflinePack> DownloadMap(OfflinePackRegion region, Dictionary<string, string> packInfo)
		{
			...
			LatLngBounds latLngBounds = new LatLngBounds.Builder()
														.Include(new LatLng(region.Bounds.NorthEast.latitude, region.Bounds.NorthEast.longitude)) // Northeast 
														.Include(new LatLng(region.Bounds.SouthWest.latitude, region.Bounds.SouthWest.longitude)) // Southwest 
														.Build();
